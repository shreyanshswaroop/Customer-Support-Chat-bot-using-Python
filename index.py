...
unidentified = {
	...
	"payment":{"keywords":["gpay","method","accept"],
	"questions":["What payment methods do you accept?"],
	"answers":["We accept all major credit cards, PayPal, and bank transfers. For a full list of payment options, please visit our payment information page"]},
}
